...
<html>
    ...
    <body>
        ...
        <a href="#janela1" rel="modal">Excluir Usuario</a> //modal para abrir janela de exclusao
...
<!-- Modal que é aberto ao clicar excluir usuário-->
      
          <div class="window" id="janela2">
                <a href="#" class="fechar">X Fechar</a>
                <h4>Exclusao de usuario</h4>
                <form id="excluiUsuario" action="" method="post">
                    <label>Nome:</label><input type="text" name="nome" id="nome" />
                    <label>Email:</label><input type="text" name="email" id="email" />
                    <br/><br/>
                    <input type="button" value="Excluir" id="excluirr" />
                </form>
            </div>
            <div id="mascara"></div>
        </div>
...
//// aqui é o script para abrir o nosso pequeno modal
      ...
      $('#excluir').click(function(NOME, EMAIL) {

            var dados = $('#excluiUsuario').serialize();
